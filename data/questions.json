[
  ...
  },
  {
    ...
    "answer": "A",
    "justification": "Dans un projet hybride, les dépendances entre la partie agile et la partie prédictive sont intégrées dans le calendrier global du projet. Les éléments physiques (les serveurs) et leurs jalons dictent le chemin critique. Si un élément sur ce chemin prend du retard, c'est toute la date de fin du projet qui est compromise. Quel a été votre score sur ce mini-test ? Si vous le souhaitez, nous pouvons faire une autre série axée sur vos domaines à améliorer (comme l'agilité ou la gestion des risques) ou détailler la méthode pour calculer les indicateurs EVM (CPI, SPI, EAC)."
  },
  {
    "id": 36,
    "exam": 3,
